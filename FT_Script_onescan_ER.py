# -*- coding: utf-8 -*-
"""
Created on Mon Apr  2 21:16:10 2018
...
MOLNAM = str(input("Molecule name:"))
FID_LEN = 6

PDRO = int(input("PDRO 18400/27200:"))
...
chirp1=np.fromfile(input("Chirp 1:"),sep = " ")
#chirp1 = np.fromfile("OFT_high_250M_4mT-12C_chirp0.csv",sep = " ")
#print(chirp1[0])
#chirp2 = np.fromfile(input("Chirp 2:"),sep = " ")
#chirp2 = np.fromfile("OFT_high_250M_4mT-12C_chirp1.csv",sep = " ")
#print(chirp2[0])
blank1 = np.fromfile(input("Blank:"),sep = " ")
#blank1 = np.fromfile("OFT_high_250M_4mT-12C_blank0.csv",sep = " ")
#blank2 = np.fromfile("OFT_high_250M_4mT-12C_blank1.csv",sep = " ")
#blank2 = np.fromfile(input("Blank2:"),sep = " ")


#chirp_corr = np.corrcoef(chirp1,chirp2)
#x = chirp_corr[1][0]
#print('The chirp correlation is '+str(x))
#if x < 0.9:
#    print('Warning! Chirps are not properly correlated!')
#else:
#    print('The chrips are well correlated')
#blank_corr = np.corrcoef(blank1, blank2)
#y = blank_corr[1][0]
#print('The blank correlation is '+str(y))

#chirps = np.add(chirp1,chirp2)
#print("Chirps added")
#blanks = np.add(blank1,blank2)
#print("Blanks added")
full_FID = np.subtract(chirp1, blank1)
